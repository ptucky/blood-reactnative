...
class ReportMainThreeScreen extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
  ...
  async componentDidMount() {
    try {
        ...
        this.setState({
          loading: false,
          userUrl: `${GlobalConfig.urlApi}/report_question/3/${reportKeyId}/${user_id}/${GlobalConfig.authToken}`,
        });
    } catch(err) {
...
ReportMainThreeScreen.navigationOptions = ({ navigation }) => ({
...
export default ReportMainThreeScreen;
